...
-- Buffer-local keymap: <leader>ll compiles the current LaTeX document
vim.api.nvim_create_autocmd("FileType", {
	group = vim.api.nvim_create_augroup("UserVimtexKeymaps", { clear = true }),
	pattern = { "tex", "bib" },
	callback = function(args)
		vim.keymap.set(
			...
			{ buffer = args.buf, silent = true, desc = "Vimtex: Compile" }
		)
	end,
})
